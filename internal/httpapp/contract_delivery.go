...
func (a *App) ensureContractDelivery(ctx context.Context,onboardingID string)(contracts.DeliveryAccess,bool,error){
	...
	if err==pgx.ErrNoRows{
		...
		if generationErr!=nil{return contracts.DeliveryAccess{},false,generationErr}
		created=true
		access=contracts.DeliveryAccess{
			ContractID:generated.ContractID,ContractStatus:"generated",SignerID:generated.SignerID,
			SignerToken:generated.SignerToken,SignerName:generated.SignerName,SignerEmail:generated.SignerEmail,SignerStatus:"pending",
		}
	}else if err!=nil{return contracts.DeliveryAccess{},false,err}
	...
	_,_ = a.pool.Exec(ctx,`
		...
		values('system','contract.sent','contract',$1,jsonb_build_object('signer_id',$2,'channel','email'))
	`,access.ContractID,access.SignerID)
	return access,created,nil
}
